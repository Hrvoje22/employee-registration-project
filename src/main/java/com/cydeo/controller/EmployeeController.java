...
public class EmployeeController {
    ...
    public String insertEmployee(@ModelAttribute("employee") @Valid Employee employee, BindingResult bindingResult, Model model){
        ...
        if(bindingResult.hasErrors()){
            model.addAttribute("stateList", DataGenerator.getAllStates()); //states were disappearing if we had an error
            return "employee/employee-create";
        }
        ...
        return "redirect:/employee/list"; //we are using endpoints not html files
